...
const EXISTING: AppearancePalette = {
  ...
  btnPrimaryGradient: '#4338ca',
  btnPrimaryGradientDark: '#4338ca',
  tableHeaderGradient: '#4338ca',
  tableHeaderGradientDark: '#4338ca',
...
const EXECUTIVE: AppearancePalette = {
  ...
  btnPrimaryGradient: '#b45309',
  btnPrimaryGradientDark: '#92400e',
