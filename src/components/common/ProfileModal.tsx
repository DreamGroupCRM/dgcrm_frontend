...
const ProfileModal: React.FC = () => {
  ...
  const InfoRow = ({
    ...
    >
      <span className="text-lg flex-shrink-0" style={{ color: '#0284c7' }}>{icon}</span>
    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        ...
        <div
          ...
          style={{
            background: isDark ? '#0f172a' : '#0284c7',
          }}
        >
          <button
          ...
          {!loading && !error && profile && (
            <>
              ...
              <div className="mt-3">
                ...
                >
                  <MdLockOutline size={17} style={{ color: '#0284c7' }} />
                  Change Password
                </button>
                ...
                {showChangePassword && (
                  <form onSubmit={handleChangePasswordSubmit} noValidate className="space-y-3 mt-2.5">
                    ...
                    <button
                      ...
                      style={{ background: '#0284c7', border: 'none', cursor: 'pointer', fontFamily: t.fontFamily }}
                    >
