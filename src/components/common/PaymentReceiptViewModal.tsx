        ...
        <div className="p-4" style={{ border: '2px solid #1e3a8a', borderRadius: 14, margin: 12 }}>
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              <span className="rounded px-2 py-1" style={{ background: '#0000FF', color: '#fff', fontSize: 9.5, fontWeight: 800 }}>PAYMENT RECEIPT</span>
          ...
          <div className="rounded" style={{ border: '2px solid #0000FF', display: 'inline-block', padding: '6px 16px', marginTop: 10 }}>
