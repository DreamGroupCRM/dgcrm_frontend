...
const Header: React.FC<HeaderProps> = ({ onMobileMenuToggle }) => {
  ...
  const SettingsMenuContent = () => (
    <>
      ...
      >
        {masterEnabled
          ? <MdCheckBox size={18} style={{ color: '#0284c7', flexShrink: 0 }} />
      ...
      <div className="flex items-center gap-0.5 flex-shrink-0">
        ...
        <div className="flex items-center gap-0.5">
          ...
          <IconBtn
            ...
            isDark={isDark}
            hoverColor={isDark ? '#facc15' : '#0284c7'}
          >
            ...
            {moreOpen && (
              <div style={{ ...dropdownStyle, minWidth: 220 }}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.background = t.hoverBg)}
                  onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.background = 'transparent')}>
                  {isDark ? <FiSun size={17} style={{ color: '#facc15' }} /> : <FiMoon size={17} style={{ color: '#0284c7' }} />}
