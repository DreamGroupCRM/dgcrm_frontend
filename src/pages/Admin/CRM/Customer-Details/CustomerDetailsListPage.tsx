      ...
      <div className="cust-toolbar-row flex items-end justify-between gap-3 mb-2" style={{ flexWrap: 'nowrap', overflowX: 'auto' }}>
        ...
        <div className="cust-toolbar-right flex items-center gap-2.5" style={{ flexWrap: 'nowrap', flexShrink: 0 }}>
          <button type="button" onClick={() => setView((v) => (v === 'grid' ? 'list' : 'grid'))}
            ...
            style={{ width: 40, height: 40, background: '#4e342e', border: '1px solid #4e342e', color: '#fff', cursor: 'pointer' }}>
                ...
                <>
                  ...
                  {(infoModal.payments || []).length > 0 && (
                    <div className="flex items-center justify-between rounded-xl px-4 py-3 mt-4" style={{ background: t.insetBg }}>
                      <span style={{ fontSize: 13, fontWeight: 800, color: '#4e342e' }}>Grand Total:</span>
