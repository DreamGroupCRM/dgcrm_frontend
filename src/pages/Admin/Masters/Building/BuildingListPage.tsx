    ...
    <div className="master-page" style={cssVars}>
      ...
      <div className="master-stat-grid-5">
        <StatCard label="Total Projects" value={summary?.total_projects ?? 0} icon={MdBusiness}
          color="#0284c7" bg={isDark ? 'rgba(37,99,235,0.12)' : '#eff6ff'} loading={loading} compact labelFontSize={14}
          ...
          <div className="flex items-center gap-1">
            ...
            {pageBtns().map((pg) => (
              <button
                ...
                className="master-page-btn"
                style={{
                  border: `1px solid ${pg === safePage ? '#0284c7' : t.surfaceBorder}`,
                  background: pg === safePage ? '#0284c7' : t.btnSecondaryBg,
