...
// Thin wrapper around the shared FormField (MasterListUI.tsx) — this page's
// own label style (fontWeight 700, fontSize 12.5, marginBottom 6) is
// preserved via the override, every call site below is unchanged.
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {existingLogoUrl ? (
                    ...
                    <MdBusiness size={20} style={{ color: '#4e342e' }} />
                  )}
                </div>
                <input
                  type="text"
