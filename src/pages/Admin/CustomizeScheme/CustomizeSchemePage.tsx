...
const SchemeSummaryRow: React.FC<{
  ...
  const cards: SchemeSummaryCard[] = [
    ...
    { label: 'Remaining Booking Amount', value: formatINR(bookingAmount + remainingBookingAmount), icon: MdAccountBalanceWallet, color: '#0000FF' },
          ...
          >
            ...
            >
              ...
              <div className="grid gap-x-3 gap-y-3 mb-3" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(165px, 1fr))' }}>
                ...
                {/* noSlider on every field below except Total Cost of Flat
